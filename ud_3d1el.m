...
% Ted Lawrence and Abhishek Sarkar

% The three classes utilized in this program are
%     Node Class
%     Element Class
%     Analysis Class
%
% Node Class
%     The node class contains the properties and methods associated with the nodes in
%     the Mastan2 model. An instance of this class is created for each node
%     within the structure. Methods are defined within the node class to
%     perform nodal operations
% 
% Element Class
%     The element class contains the properties and methods associated with
%     the 3d frame elements in the structural model defined in Mastan2. An instance
%     of this class is created for each element in the structure. Each
%     object of the class possesses the necessary structural properties a
%     full list of which can be found in the code design document. Methods
%     defined in the class perform operations that pertain to the
%     individual elements of the structure

% Analysis Class
%     The analysis class implements all the computations involved in
%     performing a structural analysis i.e. computing the global stiffness
%     matrix, nodal deflections, nodal reactions, and element forces. A
%     single instance of this class is created throughout the course of the
%     program. It contains properties specific to the global structural
%     system that neither the node nor analysis classes need be aware of. 
%     The methods of the analysis class are used to perform the computations 
%     necessary in carrying out the structural analysis. Calculations on
%     the node and element levels are delegated down to the respective class. 




% Create an object of the analysis class
analysis = ABHI_Analysis(nnodes,nele,coord,ends,w,concen,webdir,E,v,A,Ayy,Azz,...
Iyy,Izz,J,fixity);

% Run the RunAnalysis() Method of the analysis class
analysis.RunAnalysis();

% Run the GetMastan2Returns() Method of the analysis class to set output args
